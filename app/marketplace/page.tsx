      ...
      <div className="border-b border-[#1e2530]" style={{ background: "rgba(74,143,196,0.05)" }}>
        <div className="max-w-[1000px] mx-auto px-4 sm:px-8 py-2">
          <p className="font-mono text-[0.63rem] text-center" style={{ color: "#4a8fc4" }}>
            List and buy at any shop kiosk · your phone&apos;s <strong>Marketplace</strong> app browses anywhere · 10 bronze to list, +0.5% of your price per day unsold · Delivery fee between kiosks · Listings expire after 7 days
          </p>
        </div>
      </div>
          ...
          <div className="py-16 text-center border border-[#1e2530] bg-[#0c0f13]">
            ...
            {tab === "all" && !search && (
              <p className="font-mono text-[0.65rem] text-[#2a2a2a] mt-2">
                Walk up to any shop kiosk in game and open its Marketplace tab to be the first to list something.
              </p>
            )}
          </div>
        ) : (
